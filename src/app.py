...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill drills and scrimmage games",
    ...
    "Debate Team": {
        "description": "Practice debates and competitive tournaments",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["jack@mergington.edu", "evelyn@mergington.edu"]
    },
    "Programming Class": {
...
def remove_participant(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=404, detail="Participant not registered")
